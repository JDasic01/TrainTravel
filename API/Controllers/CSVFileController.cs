...
//                             startCityId = lineRecord.startCityId,
//                             endCityId = lineRecord.endCityId,
//                         };
...
//                             citiesIds = ParseCityIds(trainRouteRecord.city_ids),
...
//                         for (int i = 0; i < trainRoute.citiesIds.Count - 1; i++)
//                         {
//                             int currentCityId = trainRoute.citiesIds[i];
//                             int nextCityId = trainRoute.citiesIds[i + 1];
